...
document.querySelector("#cards").innerHTML =
  ...
  createCard(
    "06/12",
    "terça",
    createGame("Oitavas de Final", "Marrocos", "(3)0 X 0(0)", "Espanha") +
      createGame("Oitavas de Final", "Portugal", "6 X 1", "Suíça")
  ) +
  createCard(
    "09/12",
    "sexta",
    createGame("Quartas de Final", "Croácia", "(4)0 X 0(2)", "Brasil") +
      createGame("Quartas de Final", "Holanda", "(3)2 X 2(4)", "Argentina")
  ) +
  createCard(
    "10/12",
    "sábado",
  ...
  createCard(
    "13/12",
    "terça",
    createGame("Semi Final", "Argentina", "3 X 0", "Croácia")
  ) +
  createCard(
    "14/12",
    "quarta",
    createGame("Semi Final", "França", "2 X 0", "Marrocos")
  ) +
  createCard(
    "17/12",
    "sábado",
    createGame("Disputa 3º Lugar", "Marrocos", "12:00h", "Croácia")
  ) +
  createCard(
    "18/12",
    "domingo",
